...
def colorWipeAlternate(strip, color1, color2, wait_ms=50):
    """Wipe colors across display alternating between both colors."""
    for i in range(strip.numPixels()):
        if i%2:
...
if __name__ == '__main__':
    ...
    try:
        print("Running.")
        while True:
            #colorWipeAlternate(strip, Color(255, 0, 0), Color(0, 255, 0)) 
            #colorWipeAlternate(strip, Color(0, 255, 0), Color(255, 0, 0))
